                            ...
                            <div class="col-xl-8  col-lg-8">
                                <div class="header-right-3 text-end">
                                    <div class="h-top-list-3 d-inline-block">
                                        {session.data && <Link href={"/profile"}><p className="header-cart-3 inline-block"><FontAwesomeIcon className="mr-2" icon={faUser} />{session?.data?.name || session.data.user.name}</p></Link>
